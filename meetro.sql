...
CREATE TABLE `groupchat` (
  ...
  CONSTRAINT `groupchat_ibfk_1` FOREIGN KEY (`eventId`) REFERENCES `events` (`id`),
...
CREATE TABLE `location` (
  ...
  PRIMARY KEY (`id`),
  KEY `eventId` (`eventId`),
  CONSTRAINT `location_ibfk_1` FOREIGN KEY (`eventId`) REFERENCES `events` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `posts` (
  ...
  CONSTRAINT `posts_ibfk_2` FOREIGN KEY (`eventId`) REFERENCES `events` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-11-08  1:34:32
