...
import Meetro from '../../assets/MeetroLogo2.png';  // Make sure to import the logo
            ...
            <div className="w-3/5 bg-white rounded-lg shadow-lg overflow-hidden flex min-h-[400px]">
                ...
                <div className="flex-1 p-6 flex flex-col gap-6 justify-center">
                    ...
                    <form className="flex flex-col gap-4">
                        ...
                        <button className="w-28 p-2 bg-[#508C9B] text-white font-bold rounded-md hover:bg-[#134B70] mx-auto">Login</button>
                    </form>
                </div>
            </div>
        </div>
