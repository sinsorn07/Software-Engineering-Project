...
// function for image section
    ...
    return (
        <div className="edit-event-page flex flex-col items-center justify-center min-h-screen bg-gray-100 p-8 overflow-y-auto">
            {/* Header Section */}
            <div className="header-section flex items-center justify-start w-full max-w-3xl mb-8 relative">
                <button className="back-button absolute left-0 bg-gray-100 text-gray-500 px-3 py-2 text-3xl rounded-md hover:bg-pink-500 hover:text-white">
                    &lt;
                </button>
                <h2 className="text-3xl font-bold ml-12">Edit Event Details</h2></div>

            {/* Image Upload Section */}
            <div className="image-upload-section flex flex-col items-center mb-8 w-full max-w-3xl">
            ...
            {/* Form Section */}
            <div className="form-section w-full max-w-3xl space-y-6">
                {/* Event Name */}
                <div>
